export default {
  ...
  manager: {
    ...
    form: {
      ...
      persona: '客服人设',
      personaPlaceholder: '描述客服身份、语气、服务原则和回答风格',
      model: '企业客服模型',
      modelUnavailable: '未配置模型',
      configLoading: '正在加载企业客服配置，请稍候后再保存。',
      configLoadFailed: '企业客服配置加载失败，请重试后再保存。',
      industryKnowledge: '已授权行业知识库',
      industryPlaceholder: '选择当前客服可检索的行业知识库',
      revokedIndustryKnowledge: '已撤销授权（{id}）',
      answerBoundary: '回答边界',
      ...
      help: {
        ...
        persona: '定义当前客服的身份、表达风格和服务原则，最多可输入 8000 个字符。',
        model: '模型由平台管理员在企业 AICC 配置中统一指定，客服工作台仅展示，不能编辑。',
        industryKnowledge: '仅展示企业已获授权的行业知识库；所选范围随当前客服配置一并保存。',
