...
- 数据迁移: 本 variant 由历史 `hermes-main` 重命名而来，允许 `hermes-main` 到 `hermes-v2026.5.15` 的 no-op 迁移；未来新增 variant 时，迁移模块名使用安全后缀，例如从 `hermes-v2026.5.16` 迁移时模块为 `from_hermes_v2026_5_16.py`。
